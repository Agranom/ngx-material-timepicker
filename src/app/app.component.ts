...
export class AppComponent {
    ...
    controlSimpleSettings = `
        <div class="ngx-timepicker-example">
            <ngx-timepicker [defaultTime]="'11:11 am'"></ngx-timepicker>
        </div>
        <div class="ngx-timepicker-example">
            <ngx-timepicker [format]="24" [defaultTime]="'23:11'"></ngx-timepicker>
        </div>
        <div class="ngx-timepicker-example">
            <ngx-timepicker [format]="24" [defaultTime]="'23:11'"></ngx-timepicker>
        </div>
        <div class="ngx-timepicker-example">
            <ngx-timepicker [disabled]="true"></ngx-timepicker>
        </div>
    `;

    toggleSettings = `
        <div class="ngx-timepicker-example">
            <ngx-timepicker [buttonAlign]="'left'"></ngx-timepicker>
        </div>
        <div class="ngx-timepicker-example">
            <ngx-timepicker [toggleIcon]="icon"></ngx-timepicker>
            <ng-template #icon>
        ...
        <div class="ngx-timepicker-example">
            <ngx-timepicker [controlOnly]="true"></ngx-timepicker>
        </div>
    `;
}
