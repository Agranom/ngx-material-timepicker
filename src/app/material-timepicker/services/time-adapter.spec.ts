...
describe("TimeAdapter", () => {
    describe("parseTime", () => {
        ...
        it("should parse from string and return as DateTime", () => {
            ...
            expect(TimeAdapter.parseTime("11:00", { locale }).hour).toBe(
                expectedHour
            );
            expect(TimeAdapter.parseTime("11:00", { locale }).minute).toBe(
                expectedMinute
            );
            expect(TimeAdapter.parseTime("11:00 Am", { locale }).hour).toBe(
                expectedHour
            );
            expect(TimeAdapter.parseTime("11:00 Am", { locale }).minute).toBe(
                expectedMinute
            );
            expect(TimeAdapter.parseTime("11:00 am", { locale }).hour).toBe(
                expectedHour
            ...
            expect(TimeAdapter.parseTime("23:00", { locale }).hour).toBe(
                expectedHour
            );
            expect(TimeAdapter.parseTime("23:00", { locale }).minute).toBe(
                expectedMinute
            );
            expect(TimeAdapter.parseTime("11:00 Pm", { locale }).hour).toBe(
                expectedHour
            );
            expect(TimeAdapter.parseTime("11:00 Pm", { locale }).minute).toBe(
                expectedMinute
            );
            expect(TimeAdapter.parseTime("11:00 pm", { locale }).hour).toBe(
                expectedHour
        ...
        it("should parse time from latn to arab number", () => {
            ...
            expect(
                TimeAdapter.parseTime(arabicTime, {
                    locale: arabLocale,
    ...
    describe("formatTime", () => {
        it("should return time in 24-hours format", () => {
            ...
            expect(TimeAdapter.formatTime("11:00 pm", { format })).toBe(
                "23:00"
            );
        ...
        it("should return time in am/pm format", () => {
            ...
            expect(TimeAdapter.formatTime("23:00", { format })).toBe(
                "11:00 PM"
            );
            expect(TimeAdapter.formatTime("12:20 am", { format })).toBe(
                "12:20 AM"
            );
            expect(TimeAdapter.formatTime("12:20 am", { format: 33 })).toBe(
                "12:20 AM"
            );
        });
    });
    ...
    describe("isTimeAvailable", () => {
        ...
        it("should return true since time passes filter.", function() {
    ...
    describe("toLocaleTimeString", () => {
        it("should convert provided time (en-US) to provided locale (ar-AE) in 12-hours format", () => {
            ...
            expect(
                TimeAdapter.toLocaleTimeString(actual, { locale: "ar-AE" })
            ).toBe(expected);
        });
        ...
        it("should convert provided time (en-US) to provided locale (ar-AE) in 24-hours format", () => {
            ...
            expect(
                TimeAdapter.toLocaleTimeString(actual, {
                    locale: "ar-AE",
                    format: 24
                })
            ).toBe(expected);
    ...
    describe("fromDateTimeToString", () => {
        it("should return time as string in 12-hours format", () => {
            ...
            expect(
                TimeAdapter.fromDateTimeToString(dateTime, 12).toLowerCase()
            ).toBe(expected);
        });
        ...
        it("should return time as string in 24-hours format", () => {
            ...
            expect(TimeAdapter.fromDateTimeToString(dateTime, 24)).toBe(
                expected
            );
        });
